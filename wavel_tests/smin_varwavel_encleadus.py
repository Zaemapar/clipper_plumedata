...
smin_seed = 1  #Seed around which to try different minimum particle size (radius in microns)
...
powlaw = 3 # Power law for size distribution function
...
def mkifplot(graph_dir, given_theta, reflectances, smin_seed, smin_tests):
...
if __name__ == "__main__":
    ...
    graph_dir = utils.create_dirpath("smin_varwavel_encleadus", dirs_removed=1)
    ...
    for idx, alt in enumerate(given_altitudes):
        # Compute the nominal (unnormalized) particle size distribution for this altitude, at seed smin
        ...
        # Loop through minimum particle size tests
        ...
        # Make plot
        mkifplot(graph_dir, given_wavelengths, reflectances, smin_seed, smin_tests)
